					...
					?
						...
						hitList.map((product, index) => {
							if (index === 0){
								return(
									<li 
										className="hit-container algolia-hit"
										key="algolia-hit"
									>
