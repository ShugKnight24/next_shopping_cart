...
export const STICKER_CATALOG = [
  ...
  {
    id: 'spaceship',
    name: 'Cosmic Star Cruiser',
    category: 'props',
    Svg: SpaceshipPropSvg,
    tag: 'Hyperdrive',
  },
  {
    id: 'crystal',
    name: 'Luminous Starlight Crystal',
    category: 'props',
    Svg: CrystalPropSvg,
    tag: 'Bioluminescent',
  },
  {
    id: 'mushroom',
    name: 'Enchanted Forest Toadstool',
    category: 'props',
    Svg: MushroomPropSvg,
    tag: 'Woodland',
  },
  {
    id: 'rainbow',
    name: 'Prismatic Storybook Rainbow',
    category: 'props',
    Svg: RainbowPropSvg,
    tag: 'Sky Arch',
  },
  {
    id: 'dragon_egg',
    name: 'Prehistoric Dragon Egg',
    category: 'props',
    Svg: DragonEggPropSvg,
    tag: 'Ancient Hatch',
  },
